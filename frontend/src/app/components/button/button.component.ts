...
import { mergeClasses, transform } from '@entask-root/utilities/merge-classes';
import { ZardButtonVariants, buttonVariants } from './button.variants';
...
@Component({
	...
	template: `
		@if (zLoading()) {
			<span
				zType="cached"
				class="icon-loader-circle animate-spin"
			></span>
		}
